...
static const char *TAG = "notifications_app";
...
static void notifications_app_on_show(void) {
...
static void notifications_app_on_hide(void) {
  ESP_LOGI(TAG, "Notifications screen hidden");
}

static void notifications_app_on_gesture(lv_dir_t direction) {
  navigation_manager_handle_gesture(direction);
}

static const app_descriptor_t notifications_descriptor = {
    .id = APP_SYSTEM_NOTIFICATIONS,
    .type = APP_TYPE_SYSTEM,
    .name = "Notifications",
    .icon = NULL,
    .create = notifications_app_create,
    .destroy = NULL,
    .on_show = notifications_app_on_show,
    .on_hide = notifications_app_on_hide,
    .on_gesture = notifications_app_on_gesture,
};

const app_descriptor_t *notifications_app_get_descriptor(void) {
